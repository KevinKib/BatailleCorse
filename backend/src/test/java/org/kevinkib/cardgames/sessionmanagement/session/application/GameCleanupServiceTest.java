...
class GameCleanupServiceTest {
    ...
    private static final class StubRepository implements SessionRepository {
        ...
        public org.kevinkib.cardgames.sessionmanagement.session.domain.SessionToken loadSessionToken(GameId i, org.kevinkib.cardgames.game.PlayerId p) { return null; }
