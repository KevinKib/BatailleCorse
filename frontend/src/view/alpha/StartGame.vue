...
// Decorative fanned hand peeking above the panel — geometry derived from the
// card's index so the arc stays symmetric if the count ever changes.
const FAN_CARDS = [
  { rank: '10', suit: 'club' },
...
/* Decorative fanned hand — peeks above the panel */
.deco-cards {
  position: absolute;
  top: -95px;
  left: 50%;
